...
@section('title', 'Редактирование новости | KotiksCMS')
...
@section('content')
    ...
    <div class="page-actions fade-in">
        <div>
            <h1 class="h5 mb-0">Редактирование новости</h1>
    ...
    <form action="{{ route('admin.news.update', $news) }}" method="POST" id="editNewsForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control " id="slug" name="slug" value="{{ old('title', $news->slug) }}" required="" pattern="[a-z0-9-]+" maxlength="255" placeholder="url-news" data-manual="true">
                        ...
                        <div class="mb-3">
                            ...
                            @if($news->image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($news->image) }}" alt="" style="max-height: 100px;" class="img-thumbnail">
                                </div>
                            @endif
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      maxlength="500">{{ old('meta_description', $news->meta_description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">{{ $news->author->name ?? 'Не указан' }}</div>
                                </div>
                            </div>
                            @if($news->updater)
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">{{ $news->updater->name }}</div>
                                </div>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select multiple class="form-select @error('categories') is-invalid @enderror" 
                                ...
                                @foreach($categories as $cat)
                                    @php $selected = old('categories', $news->categories->pluck('id')->toArray()) @endphp
