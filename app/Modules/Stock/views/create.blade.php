...
@section('title', 'Создание акции | KotiksCMS')
...
news
    ...
    <div class="page-actions fade-in">
        <div>
            <h1 class="h5 mb-0">Создание Акции</h1>
            <p class="text-muted mb-0" style="font-size: 0.85rem;">
                Заполните форму ниже для добавления новой акции
            </p>
        </div>
    ...
    <!-- Форма создания -->
    <form action="{{ route('admin.stock.store') }}" method="POST" id="createStockForm" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control " id="slug" name="slug" value="" required="" pattern="[a-z0-9-]+" maxlength="255" placeholder="url-stock" data-manual="true">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      name="excerpt" 
                                      rows="3"
                                      placeholder="Краткое содержание акции...">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="6"
                                      placeholder="Полный текст акции...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Загрузите изображение для акции.</small>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i> Создать акцию
                            </button>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('title').addEventListener('blur', function() {
            ...
            if (title && !metaKeywords.value) {
                metaKeywords.value = title.toLowerCase().replace(/\s+/g, ', ') + ', акции';
            }
        });
    });
</script>
