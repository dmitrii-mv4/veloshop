...
@section('title', 'Категории акций | KotiksCMS')
...
@section('content')
    ...
    <div class="btn-group" role="group">
        ...
        <a href="{{ route('admin.stock.categories.index') }}" class="btn btn-primary">
    ...
    <div class="page-actions fade-in">
        <div>
            <h1 class="h5 mb-0">Категории акций</h1>
            <p class="text-muted mb-0" style="font-size: 0.85rem;">
                Всего: {{ $categories->total() }}
            </p>
        </div>
        <a href="{{ route('admin.stock.categories.create') }}" class="btn btn-primary">
    ...
    <div class="card fade-in mb-4">
        <div class="card-body p-3">
            <form method="GET" action="{{ route('admin.stock.categories.index') }}" class="row g-2">
                <div class="col-md-8">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.stock.categories.index') }}" class="btn btn-outline-secondary btn-sm">
                    ...
                    <tbody>
                        @forelse($categories as $category)
                            <tr>
                                ...
                                <td>{{ $category->stock()->count() }}</td>
                                <td>
                                    <div class="table-actions justify-content-end">
                                        <a href="{{ route('admin.stock.categories.edit', $category) }}"
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm delete-category-btn"
                                                ...
                                                data-delete-url="{{ route('admin.stock.categories.destroy', $category) }}"
                                ...
                                <td colspan="5" class="text-center py-4">
                                    <div class="text-muted">
                                        ...
                                        @if(request()->has('search'))
                                            <a href="{{ route('admin.stock.categories.index') }}" class="btn btn-primary btn-sm mt-2">
                                                Сбросить фильтры
                                            </a>
                                        @else
                                            <a href="{{ route('admin.stock.categories.create') }}" class="btn btn-primary btn-sm mt-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger alert-sm mb-0">
                        ...
                        Это действие удалит категорию. Акции останутся, но потеряют связь с этой категорией.
                    </div>
                </div>
