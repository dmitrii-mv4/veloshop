...
@section('content')
    <div class="page-header fade-in">
        @include('admin::partials.breadcrumb', [
            'items' => [
                ...
                ['title' => 'Категории', 'url' => route('admin.stock.categories.index')],
    ...
    <div class="card fade-in">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.stock.categories.update', $category) }}">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.stock.categories.index') }}" class="btn btn-outline-secondary">Отмена</a>
