                                ...
                                <div class="block-content">
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <input type="text" class="@error('name') is-invalid @enderror form-control" id="example-text-input" name="title" placeholder="" value="{{ $page->title }}">
                                                @error('title')
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <textarea id="js-ckeditor" name="content" class="form-control @error('name') is-invalid @enderror form-control" rows="4">{{ $page->content }}</textarea>
                                                @error('content')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="block block-rounded">
                                <div class="block-content">
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <input type="text" class="@error('meta_slug') is-invalid @enderror form-control" id="example-text-input" name="meta_slug" placeholder="" value="{{ $page->meta_slug }}">
                                                @error('meta_slug')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <input type="text" class="@error('meta_title') is-invalid @enderror form-control" id="example-text-input" name="meta_title" placeholder="" value="{{ $page->meta_title }}">
                                                @error('meta_title')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror form-control" rows="4">{{ $page->meta_description }}</textarea>
                                    ...
                                    <div class="row push">
                                        ...
                                        <div class="col-lg-8 col-xl-5">
                                            <div class="mb-4">
                                                <input type="text" class="@error('meta_keys') is-invalid @enderror form-control" id="example-text-input" name="meta_keys" placeholder="" value="{{ $page->meta_keys }}">
                                                @error('meta_keys')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
