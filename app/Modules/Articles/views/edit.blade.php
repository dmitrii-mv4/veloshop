...
@section('title', 'Редактирование статьи | KotiksCMS')
...
@section('content')
    ...
    <div class="page-actions fade-in">
        <div>
            <h1 class="h5 mb-0">Редактирование статьи</h1>
    ...
    <form action="{{ route('admin.articles.update', $articles) }}" method="POST" id="editArticlesForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row fade-in">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="title" class="form-label required">Заголовок статьи</label>
                            <input type="text" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control " id="slug" name="slug" value="{{ old('title', $articles->slug) }}" required="" pattern="[a-z0-9-]+" maxlength="255" placeholder="url-articles" data-manual="true">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      id="excerpt" 
                                      name="excerpt" 
                                      rows="3">{{ old('excerpt', $articles->excerpt) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" 
                                      name="description" 
                                      rows="6">{{ old('description', $articles->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            @if($articles->image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($articles->image) }}" alt="" style="max-height: 100px;" class="img-thumbnail">
                                </div>
                            @endif
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="meta_title" 
                                   name="meta_title" 
                                   value="{{ old('meta_title', $articles->meta_title) }}"
                                   maxlength="255">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      maxlength="500">{{ old('meta_description', $articles->meta_description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="meta_keywords" 
                                   name="meta_keywords" 
                                   value="{{ old('meta_keywords', $articles->meta_keywords) }}"
                                   maxlength="500"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">{{ $articles->author->name ?? 'Не указан' }}</div>
                                </div>
                            </div>
                            @if($articles->updater)
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">{{ $articles->updater->name }}</div>
                                </div>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select multiple class="form-select @error('categories') is-invalid @enderror" 
                                ...
                                @foreach($categories as $cat)
                                    @php $selected = old('categories', $articles->categories->pluck('id')->toArray()) @endphp
