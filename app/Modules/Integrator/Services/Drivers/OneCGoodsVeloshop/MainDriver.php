...
namespace App\Modules\Integrator\Services\Drivers\OneCGoodsVeloshop;

use App\Modules\Integrator\Services\Interfaces\DriverInterface;
use App\Modules\Integrator\Services\Drivers\OneCGoodsVeloshop\Helpers\SettingsFormHelper;
use SoapClient;
use SoapFault;
use Exception;
...
class MainDriver implements DriverInterface
{
     ...
     * @var string
     */
    protected string $name = '1C:Товары (Велошоп)';
     ...
     * @var string
     */
    protected string $description = 'Интеграция с внешним сервисом 1С для выгрузки товаров на сайт Велошоп';
     ...
     * @var string
     */
    protected string $iconClass = 'fas fa-database';
