...
@section('title', 'Редактирование заказа | KotiksCMS')
...
@section('content')
    ...
    <div class="page-actions fade-in">
        <div>
            <h1 class="h5 mb-0">Редактирование заказа #{{ $order->order_number }}</h1>
    ...
    <form action="{{ route('catalog.orders.update', $order) }}" method="POST" id="order-form">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('customer_id') is-invalid @enderror" 
                                ...
                                @foreach($customers as $id => $name)
                                    <option value="{{ $id }}" {{ old('customer_id', $order->customer_id) == $id ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('responsible_id') is-invalid @enderror" 
                                ...
                                @foreach($responsibles as $id => $name)
                                    <option value="{{ $id }}" {{ old('responsible_id', $order->responsible_id) == $id ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('comment') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      maxlength="2000"
                                      placeholder="Дополнительная информация о заказе">{{ old('comment', $order->comment) }}</textarea>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           name="is_cancelled" 
                                           value="1"
                                           {{ old('is_cancelled', $order->is_cancelled) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           name="has_problem" 
                                           value="1"
                                           {{ old('has_problem', $order->has_problem) ? 'checked' : '' }}>
                        ...
                        <div class="cancellation-reason-field">
                            ...
                            <textarea class="form-control @error('cancellation_reason') is-invalid @enderror" 
                                      ...
                                      rows="4"
                                      maxlength="2000"
                                      placeholder="Подробно укажите причину отмены заказа...">{{ old('cancellation_reason', $order->cancellation_reason) }}</textarea>
                            <div class="char-counter mt-1">
                        ...
                        <div class="problem-description-field mt-3">
                            ...
                            <textarea class="form-control @error('problem_description') is-invalid @enderror" 
                                      ...
                                      rows="4"
                                      maxlength="2000"
                                      placeholder="Подробно опишите проблему с заказом...">{{ old('problem_description', $order->problem_description) }}</textarea>
                            <div class="char-counter mt-1">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label small">Создан</label>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    @if($order->creator && $order->creator->name)
                                        <small class="text-muted">{{ $order->creator->name }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    @if($order->updater && $order->updater->name)
                                        <small class="text-muted">{{ $order->updater->name }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>

                        <!-- Текущий автор изменений -->
