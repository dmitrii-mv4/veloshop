...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        // Создаем индекс для поиска товаров по групповому названию
        DB::statement('CREATE INDEX IF NOT EXISTS catalog_products_group_name_index ON catalog_products(group_name)');
    ...
    public function down()
    {
        ...
        DB::statement('DROP INDEX IF EXISTS catalog_products_group_name_index');
