...
/**
 * Request класс для валидации данных при редактировании заказа
 *
 * Содержит правила валидации и сообщения об ошибках для формы редактирования заказа
 */
    ...
    public function rules(): array
    {
        ...
        return [
            'order_number' => [
                ...
                'string',
                'max:100',
                Rule::unique(Order::getTableName(), 'order_number')->ignore($orderId),
            ],
            'customer_id' => [
                'required',
                'exists:users,id',
