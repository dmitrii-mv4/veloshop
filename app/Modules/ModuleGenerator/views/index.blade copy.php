    ...
    <div class="content">
        <div
            ...
            <div>
                ...
                <p class="text-muted">{{ trans('app.modules.description') }}</p>
            </div>
            <div class="mt-4 mt-md-0">
                <a href="{{ route('admin.module_generator.create') }}">
                    <button type="button" class="btn btn-alt-success me-1 mb-3">
                        <i class="fa fa-fw fa-plus opacity-50 me-1"></i> {{ trans('app.modules.create') }}
                    </button>
                </a>
            </div>
        </div>
    ...
    <div class="content">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ trans('app.modules.name') }}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ trans('app.modules.name') }}</h3>
            </div>
