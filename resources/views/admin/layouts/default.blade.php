...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="/assets/admin/js/plugins/select2/css/select2.min.css">
    <link rel="stylesheet" id="css-main" href="/assets/admin/js/plugins/ion-rangeslider/css/ion.rangeSlider.css">
</head>
<body>

<!-- Модальное окно для переводов -->
@include('admin.include.translations_popup')
        ...
        <div class="bg-header-dark">
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="{{ route('admin.dashboard') }}">
              ...
              <span class="smini-hidden">{{ $settings['name_site'] }}</span>
            </a>
            <!-- END Logo -->
